...
export default function Home() {
  ...
  return (
    <div className=' w-screen h-screen flex flex-row'>
      <div className='w-full  md:w-7/12 bg-bg-pattern bg-no-repeat bg-cover'>
        <div className=' flex flex-col w-full py-5 md:py-16 px-0 md:px-12 lg:px-32 xl:px-40'>
          ...
          <div className='px-8 md:px-0 w-full h-full'>
            ...
            {show && (
              <div className=' mt-28 font-josefin text-custom-200 ml-5'>
      ...
      <div className='w-0 md:w-5/12 relative'>
        <Image
